...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    id: 'Recordings',
    label: 'Recordings',
    icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2"><rect x="3" y="5" width="18" height="14" rx="2" /><circle cx="12" cy="12" r="3" /></svg>
  },
  {
    id: 'About',
    label: 'About',
