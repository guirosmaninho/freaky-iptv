...
const x86Runtime = path.resolve(projectRoot, 'libvlc-proxy-runtime', 'libvlc', 'win-x86');
const expectedParent = path.resolve(projectRoot, 'libvlc-proxy-runtime', 'libvlc');
